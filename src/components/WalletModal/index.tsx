        ...
        params: [
          {
            ...
            blockExplorerUrls: ['https://explorer.starscan.io/evm'],
          },
        ],
      })
      .catch((error: any) => {
          ...
          <LightCard style={{ marginBottom: '16px' }}>
            <AutoRow style={{ flexWrap: 'nowrap' }}>
              <TYPE.main fontSize={14}>
                ...
                <ExternalLink href="https://functionx.io/home">Terms of Service</ExternalLink> and acknowledge that you
                have read and understand the{' '}
                <ExternalLink href="https://functionx.io/home">Function X protocol disclaimer</ExternalLink>.
              </TYPE.main>
            </AutoRow>
          </LightCard>
