...
export function swapErrorToUserReadableMessage(error: any): string {
  ...
  switch (reason) {
    ...
    case 'FXSwapV2Router: INSUFFICIENT_OUTPUT_AMOUNT':
    case 'FXSwapV2Router: EXCESSIVE_INPUT_AMOUNT':
    ...
    case 'FXSwapV2: TRANSFER_FAILED':
      return 'The output token cannot be transferred. There may be an issue with the output token.'
    case 'FXSwappV2: K':
      return 'The FXSwap invariant x*y=k was not satisfied by the swap. This usually means one of the tokens you are swapping incorporates custom behavior on transfer.'
