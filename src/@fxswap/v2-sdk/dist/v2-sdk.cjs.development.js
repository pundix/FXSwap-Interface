...
var FACTORY_ADDRESS = '0x9E229BE3812228454499FAf771b296bedFe8c904';
var INIT_CODE_HASH = '0x89bbd161b7f9309df13e388d6b1f71f5ff07259b5149560e726a4df10971bceb';
...
var Pair = /*#__PURE__*/function () {
  function Pair(currencyAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new sdkCore.Token(tokenAmounts[0].currency.chainId, Pair.getAddress(tokenAmounts[0].currency, tokenAmounts[1].currency), 18, 'FX-V2', 'Function X V2');
...
(function (ChainId) {
  ChainId[ChainId["DHOBYGHAUT"] = 90001] = "DHOBYGHAUT";
  ChainId[ChainId["FXCORE"] = 530] = "FXCORE";
})(ChainId || (ChainId = {}));
...
var WETH9 = (_WETH = {}, _WETH[exports.ChainId.FXCORE] = /*#__PURE__*/new Token(exports.ChainId.FXCORE, '0x80b5a32E4F032B2a058b4F29EC95EEfEEB87aDcd', 18, 'WETH9', 'Wrapped Ether'),  _WETH[exports.ChainId.DHOBYGHAUT] = /*#__PURE__*/new Token(exports.ChainId.DHOBYGHAUT, '0x3452e23F9c4cC62c70B7ADAd699B264AF3549C19', 18, 'WETH9', 'Wrapped Ether'), _WETH);
/**
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    ...
    switch (trade.tradeType) {
      case sdkCore.TradeType.EXACT_INPUT:
        if (etherIn) {
          methodName = useFeeOnTransfer ? 'swapExactFXForTokensSupportingFeeOnTransferTokens' : 'swapExactFXForTokens'; // (uint amountOutMin, address[] calldata path, address to, uint deadline)

          args = [amountOut, path, to, deadline];
          value = amountIn;
        } else if (etherOut) {
          methodName = useFeeOnTransfer ? 'swapExactTokensForFXSupportingFeeOnTransferTokens' : 'swapExactTokensForFX'; // (uint amountIn, uint amountOutMin, address[] calldata path, address to, uint deadline)
      ...
      case sdkCore.TradeType.EXACT_OUTPUT:
        ...
        if (etherIn) {
          methodName = 'swapFXForExactTokens'; // (uint amountOut, address[] calldata path, address to, uint deadline)

          args = [amountOut, path, to, deadline];
          value = amountIn;
        } else if (etherOut) {
          methodName = 'swapTokensForExactFX'; // (uint amountOut, uint amountInMax, address[] calldata path, address to, uint deadline)
